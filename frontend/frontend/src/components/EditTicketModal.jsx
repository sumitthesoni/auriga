  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-lg shadow-xl border border-slate-200 w-full max-w-lg overflow-hidden"
        role="dialog"
      >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm rounded-md border border-slate-300 bg-white focus:border-blue-600"
              >
