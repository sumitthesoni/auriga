    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          ...
          className="absolute left-0 mt-1 w-64 origin-top-left rounded-md bg-white shadow-lg border border-slate-200 z-50 py-1.5 text-sm focus:outline-none"
          role="listbox"
        >
          <div className="px-2.5 pb-2 pt-1 border-b border-slate-100">
            <div className="relative">
              ...
              <input
                ...
                autoFocus
                className="w-full pl-8 pr-2.5 py-1 text-xs rounded border border-slate-200 focus:outline-none focus:border-slate-400"
              />
            </div>
          </div>
