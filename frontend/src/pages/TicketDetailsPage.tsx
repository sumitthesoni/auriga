...
import { OverdueBadge, formatDate } from '../components/OverdueBadge';
...
export function TicketDetailsPage() {
  ...
  return (
    <div id="ticket-details-page" className="space-y-5 max-w-5xl mx-auto">
      ...
      {/* Main Grid: Left details, Right side quick-action panel */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Left Column: Description & Customer Info */}
        ...
        {/* Right Column: Interactive Assignment & Status Controls */}
