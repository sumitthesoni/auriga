...
export function LoginPage() {
  ...
  const [password, setPassword] = useState('Project');
  ...
  const sampleStaff = [
    ...
    { name: 'Rahul Verma', email: 'rahul.verma@helpdesk.example.com' },
    { name: 'Amit Sharma', email: 'amit.sharma@helpdesk.example.com' },
  ];
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition-all font-medium text-slate-900"
              />
            </div>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <div className="flex items-center gap-1">
              {backendHealth === 'healthy' ? (
                ...
                <span className="text-amber-600 font-medium" title="Interactive Simulator mode ready">
                  Sandbox Active
                </span>
              )}
            </div>
